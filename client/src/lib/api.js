...
export const sally = {
  ...
  makeCommunityPrivate: (community_id) => call('sally_makeCommunityPrivate', { community_id }),
  makeCommunityPublic: (community_id) => call('sally_makeCommunityPublic', { community_id }),
};
